...
import { Material, MaterialDocument } from '../../../src/api/materials/schemas/material.schema';
...
describe('PartsController', () => {
  ...
  describe('findAll', () => {
    it('Should return a list of all parts', async () => {
      ...
      jest.spyOn(materialService, 'findAll').mockImplementation(async () => await result);
  ...
  describe('findOne', () => {
    it('Should return a from by its username', async () => {
      ...
      jest.spyOn(materialService, 'findOne').mockImplementation(async () => await result)
  ...
  describe('create', () => {
    it('Should create a new part', async () => {
      ...
      jest.spyOn(materialService, 'create').mockImplementation(async () => await result);
  ...
  describe('remove', () => {
    it('Should remove a part by its name', async () => {
      ...
      jest.spyOn(materialService, 'remove').mockImplementation(async () => await result);
  ...
  describe('update', () => {
    it('Should update user attribute values', async () => {
      ...
      jest.spyOn(materialService, 'update').mockImplementation(async () => await result)

      expect(await materialController.update(result.name, updatedMaterial)).toBe(result);
    });
  });
});
